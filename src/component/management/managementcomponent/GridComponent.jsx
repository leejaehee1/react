...
const GridComponent = () => {
            ...
            if(dateToData.includes(a)) {
                ...
                for (var rD in data) {
                    ...
                    if (a === 'issuedDate'){
                        ...
                        dateTypeData = (data[rD]['issuedDate'])?data[rD]['issuedDate']:data[rD]['IssuedDate'];
                        ...
                        dateTypeData = (data[rD]['targetDate'])?data[rD]['targetDate']:data[rD]['TargetDate'];
                        // // console.log(typeof(rD['IssuedDate']))
                        if (typeof(dateTypeData)=== 'number'){
                            // // console.log('number 찍혔다.')
                            // // console.log(ExcelDateToJSDate(dateTypeData))
                        ...
                        dateTypeData = (data[rD]['completedDate'])?data[rD]['completedDate']:data[rD]['CompletedDate'];
                        // // console.log(typeof(rD['IssuedDate']))
                        if (typeof(dateTypeData)=== 'number'){
                            // // console.log('number 찍혔다.')
                            // // console.log(ExcelDateToJSDate(dateTypeData))
                        ...
                        dateTypeData = (data[rD]['confirmedDate'])?data[rD]['confirmedDate']:data[rD]['ConfirmedDate'];
                        // // console.log(typeof(rD['IssuedDate']))
                        if (typeof(dateTypeData)=== 'number'){
                            // // console.log('number 찍혔다.')
                            // // console.log(ExcelDateToJSDate(dateTypeData))
                        ...
                        dateTypeData = (data[rD]['closedDate'])?data[rD]['closedDate']:data[rD]['ClosedDate'];
                        // // console.log(typeof(rD['IssuedDate']))
                        if (typeof(dateTypeData)=== 'number'){
                            // // console.log('number 찍혔다.')
                            // // console.log(ExcelDateToJSDate(dateTypeData))
                        ...
                        dateTypeData = (data[rD]['scheStartDate'])?data[rD]['scheStartDate']:data[rD]['ScheStartDate'];
                        // // console.log(typeof(rD['IssuedDate']))
                        if (typeof(dateTypeData)=== 'number'){
                            // // console.log('number 찍혔다.')
                            // // console.log(ExcelDateToJSDate(dateTypeData))
                        ...
                        dateTypeData = (data[rD]['scheStartDate'])?data[rD]['scheFinishDate']:data[rD]['ScheFinishDate'];
                        // // console.log(typeof(rD['IssuedDate']))
                        if (typeof(dateTypeData)=== 'number'){
                            // // console.log('number 찍혔다.')
                            // // console.log(ExcelDateToJSDate(dateTypeData))
    ...
    const handleSubmit = (event) => {
        ...
        updateColDefs.current.forEach((a)=> {
                try {
