...
const ComponentToPrint = (props) => {
    ...
    }, [getPhotos, props.downDetailData?.punchID])

    useEffect(()=> {
        var targetData = ''
        if(getDrawing.length) {
            getDrawing.forEach(rw => {
    ...
    }, [getDrawing, props.downDetailData?.projectID])
    ...
    }, [getProjectID, props.downDetailData.projectID])
    ...
    }, [getDiscipline, props.downDetailData.discipline])
    ...
    }, [getDepartment, props.downDetailData.department])
    ...
    }, [getSystem, props.downDetailData.systemID])
    ...
    }, [getSubSystem, props.downDetailData.subsystem])
